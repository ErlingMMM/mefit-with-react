    ...
    <div className="min-h-screen flex flex-col justify-center items-center p-4 mt-11">
      ...
      <form className="">
        ...
        <div className="mb-2 p-4 rounded flex items-start">
          ...
          <div>
            <label htmlFor="html" className="text-lg font-bold">15 days</label><br />
        ...
        <div className="mb-2 p-4 rounded flex items-start">
          ...
          <div>
            <label htmlFor="css" className="text-lg font-bold">30 days</label><br />
        ...
        <div className="mb-2 p-4 rounded flex items-start">
          ...
          <div>
            <label  htmlFor="javascript" className="text-lg font-bold">60 days</label><br />
