...
function DeleteUserView () {
  ...
  <div className="mb-4">
                ...
                <button    onClick={() =>  DeleteUserClick(user.id)} className="bg-[#a3e635] hover:bg-red-600 text-custom-black py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                  Delete
                </button>
              </div>
            ))}
