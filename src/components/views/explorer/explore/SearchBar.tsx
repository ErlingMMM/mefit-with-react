...
function SearchBar({ searchQuery, setSearchQuery, placeholder, availableSearchOptions }: SearchBarProps) {
  ...
  return (
    <div className="flex justify-center">
      <div className="external-input-style border-2 border-gray-400 bg-white h-12 w-10/12 sm:w-6/12 rounded-3xl text-sm focus:outline-none inline-block relative">
