  ...
  return (
    <div className="sm:flex sm:space-x-4 nav-links hidden justify-between bg-black py-2">
      ...
      <div className="space-x-10 flex items-center ml-4 text-white ">
        ...
        <button className='text-custom-green text-center hover:opacity-70' onClick={() => switchToComponent('profile')} style={{ cursor: 'pointer', background: 'none', border: 'none', outline: 'none' }}>
            <img
